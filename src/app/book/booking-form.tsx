...
const hostelOptions = [
  "Male Hall 1", "Male Hall 2", "Male Hall 3", "Male Hall 4", "Male Hall 5", "Male Hall 6", "Male Hall 7",
  "Med Male Hostel", "Wema Hostel", "ABUAD Hostel", "NFH 1", "NFH 2", "Female Med Hostel"
] as const;
...
const formSchema = z.object({
  ...
  hostel: z.enum(hostelOptions, {
    required_error: "Please select your hostel.",
  }),
...
export function BookingForm() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    const formattedDate = format(values.departureDate, "PPP");
    const message = `
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="flex items-center"><Home className="mr-2 h-4 w-4 text-primary/80" />Hostel</FormLabel>
                <Select onValueChange={field.onChange} defaultValue={field.value}>
                  <FormControl>
                    <SelectTrigger>
           ...
           <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col pt-2">
                <FormLabel className="flex items-center mb-1"><CalendarIcon className="mr-2 h-4 w-4 text-primary/80" />Departure Date</FormLabel>
                <Popover>
